...
(
	...
	DisplayName	NVARCHAR(100) NOT NULL DEFAULT N'Tam team',
...
EXEC dbo.USP_GetAccountByUserName @userName = N'tam'
...
SELECT * FROM Account WHERE UserName = 'tam' AND PassWord = '123456'
